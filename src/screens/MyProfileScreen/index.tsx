...
import {Text, PressableNavigation, NameCard} from '../../components';
  ...
  return (
    <SafeAreaView style={safeAreaViewStyle}>
      ...
      <View style={container}>
        ...
        />
        <PressableNavigation
          nameTitle={'Payment methods'}
          infoTitle={`${card}`}
          onPress={onPressCard}
        />
        <PressableNavigation
          nameTitle={'Promocodes'}
          infoTitle={promocodes}
          onPress={onPressPromocodes}
        />
        <PressableNavigation
        ...
        <PressableNavigation
          nameTitle={'Settings'}
          infoTitle={'Notifications, password'}
