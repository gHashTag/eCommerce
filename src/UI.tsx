    ...
    <ScrollView style={container}>
      <View style={layoutContainer}>
        ...
        <CardProductBag
          ...
          color={'example'}
          imageUri={
            'https://demotivation.ru/wp-content/uploads/2020/05/255095-Sepik-2048x1383.jpg'
          }
          clothes={'example'}
          size={'example'}
        />
        ...
        <Space height={10} />
        <CheckBox
          value={redCheckBoxValue}
          isPrimary={true}
          onToggle={toggleRedCheckBox}
        />
        <Space height={10} />
        <CheckBox
          value={whiteCheckBoxValue}
          isPrimary={false}
          onToggle={toggleWhiteCheckBox}
        />
        <Space height={25} />
        <Text title="DropDown" h1 textStyle={textStyle} />
        <Space height={10} />
        <DropDown
          list={['listExample', 'ListExample1']}
          width={300}
          label={'asdf'}
        />
        <Space height={25} />
        ...
        <TagBig
          title={'Tag'}
          onToggle={toggleTagBig}
          isInvisibleBorder={isInvisibleBorder}
        />
        <Space height={10} />
        <TagSmall
          title={'Tag'}
          onToggle={toggleTagSmall}
      ...
      <View style={layoutContainer}>
        ...
        <Button
          ...
          title={'Open FiltersScreen!'}
        />
        <Space height={25} />
        <Text title="MyOrdersScreen" h1 textStyle={textStyle} />
        <Space height={10} />
        <Button
          onPress={openMyOrdersScreen}
          isSmall={false}
          isOutline={false}
          title={'Open MyOrdersScreen!'}
        />
        <Space height={25} />
